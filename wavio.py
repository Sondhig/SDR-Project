...
if __name__ == "__main__":
    ...
    in_fname = "../data/testoutput.bin"
    # read data from a binary file (assuming 32-bit floats)
    float_data = np.fromfile(in_fname, dtype=np.int16)
    ...
    print(float_data)
    reshaped_data = np.reshape(float_data, (-1,2)) #this line uncommented for stereo
    ...
    audio_Fs = 48000
    print()
    wavfile.write("../data/audio_processed.wav", audio_Fs, reshaped_data.astype("int16"))
